...

        {
          ...
          <div className="top flex justify-between p-5 items-center bg-[#F5F5F3]">
            ...
            <div className="text flex flex-col gap-3">
               <p className="name font-DM font-bold text-sm text-Primary">Black Smart Watch</p>
                <p className="price font-DM font-bold text-sm text-Primary">$44.00</p>
              </div>
              </div>
            <div className="icon">
            <IoClose />
          ...
          <div className="bottom p-5 bg-white">
            ...
            <div className="btn flex gap-5">
              <Link to="/Sign/Up"><Button  ButtonText="View Cart"/></Link>
...

{
          account && (
            <div className="account w-[200px] absolute right-[58px] top-full z-10">
              <Button className='!w-full border !border-[#F0F0F0]'  ButtonText="My Account"/>
              <Button className='!w-full border !border-[#F0F0F0]' ButtonText="Log Out"/>
          </div>
     ...
     {
      filterData.length > 0 && (
        <ul className="bg-gray-400 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 p-5 gap-2 absolute top-full left-0 w-full z-20">
          {
            ...
            <img className="h-40" src={item.thumbnail} alt={item.thumbnail} />
             ...
             <div className="flex flex-col justify-center items-end">
              <button className="py-2 px-3 bg-slate-500 font-DM mb-2">Add to Cart</button>
              <button className="py-2 px-3 bg-slate-500 font-DM">Wishlist</button>
             </div>
            </li>
            ))
          }
